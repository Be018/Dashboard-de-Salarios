...
# Define o titulo da página, o icone e o layout para ocupar a largura inteira.
st.set_page_config(
...
st.markdown('Explore os dados salariais na área de dados nos últimos anos. Utilize os filtros à esquierda para refinar a sua analise.')
